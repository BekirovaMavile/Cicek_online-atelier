...
<v-container class="mt-10 mb-10">
    <v-row>
        <v-col cols="12" md="6" class="text-center mt-6 mb-10 info-reg">
        ...
        <v-col cols="12" md="6">
            ...
            <v-form ref="form" @submit.prevent="submitForm">
                <v-select v-model="role" :items="['Пользоваетль', 'Ателье']" label="Выберите роль"></v-select>
                <v-text-field v-if="role === 'Пользоваетль'" v-model="first_name" :rules="nameRules" label="Введите имя пользователя"></v-text-field>
                <v-text-field v-if="role === 'Ателье'" v-model="first_name" :rules="nameRules" label="Введите название ателье"></v-text-field>
                <v-text-field v-if="role === 'Пользоваетль'" v-model="last_name" :rules="nameRules" label="Введите фамилию пользователя"></v-text-field>
