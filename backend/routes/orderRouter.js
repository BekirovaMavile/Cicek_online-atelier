...
router.put("/status", verifyJWT, OrderController.updateStatus) // Позже стоит добавить проверку на роль, так как только админ или ателье может устанавливать статус заказа
